...
![screenraceline](README.assets/theme_carbon/screenshot_race_line.png)
...
There is a `Dockerfile` and [readily made images](https://github.com/bluess57/gt7dashboard/pkgs/container/gt7dashboard) available.
...
docker pull ghcr.io/bluess57/gt7dashboard:main
